...
params.projectDir = "/mmfs1/projects/rick.jansen/DeewanB/RNAseq_coinfection/SRP279559" 
...
log.info """\
    ...
    ===================================
    bowtie2 index       : ${params.bowtie2index}
    reads               : ${params.reads}
